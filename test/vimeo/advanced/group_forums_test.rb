...
class GroupForumsTest < Test::Unit::TestCase
  ...
  context "vimeo advanced group events" do
    ...
    should "be able to get a list comments for a group forum topic" do
      stub_advanced_get("?api_key=12345&topic_id=topic_id&group_id=group_id&format=json&method=vimeo.groups.forums.getTopicComments&api_sig=920d90a99e5af12339865b07314e2f49", "advanced/group_forums/get_topic_comments.json")
    ...
    should "be able to get a list of group forum topics" do
      stub_advanced_get("?api_key=12345&group_id=group_id&format=json&method=vimeo.groups.forums.getTopics&api_sig=23ac4e1deac83f0ef175a8f4fdaf32a2", "advanced/group_forums/get_topics.json")
